...
import { getTableConfigForAWorkSheet } from './getTableConfigExcel.mjs';
...
export async function parseAndTransformXLSXAllSheets(filePath, tableConfigFile, timezone, callBack, onComplete) {
  try {
